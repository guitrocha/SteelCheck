...
public class DCompressaoActivity extends AppCompatActivity
    ...
    class SecaoSpinnerClass implements AdapterView.OnItemSelectedListener {
        public void onItemSelected(AdapterView<?> parent, View view, final int position, long id) {
            ...
            scv = (ScrollView) findViewById(R.id.scrollView_dcomp_id);
            ...
            {   scv.setBackground(getResources().getDrawable(android.R.drawable.editbox_dropdown_light_frame));
                if(position == 1)
                {
                    ...
                    image.setImageDrawable(ContextCompat.getDrawable(DCompressaoActivity.this, R.drawable.perfil_laminado));
                ...
                TextView TV_ordenar = new TextView(DCompressaoActivity.this);
                ...
                Spinner spin_orderby = new Spinner(DCompressaoActivity.this);
                ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(DCompressaoActivity.this,R.array.orderby_compr, android.R.layout.simple_spinner_item);
                adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
                ...
                botao_dimens.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        {
                            Intent intent = new Intent(new Intent(DCompressaoActivity.this,OutputDCompressaoActivity.class));
                            //intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                            //intent.addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
